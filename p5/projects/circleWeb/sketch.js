  ...
  const drawWeb = (
    ...
    */
    ...
    const linkCircles = (c1, c2, r, linksCt) => {
      ...
      */
      let c1AngleOffset = angleBetween(
        c1Coords.x,
        c1Coords.y,
        c2Coords.x,
        c2Coords.y
      ...
      let c2AngleOffset = angleBetween(
        c2Coords.x,
        c2Coords.y,
        c1Coords.x,
        c1Coords.y
...
//       c2AngleOffset -= iterator
    ...
    const r = distanceOf(vertices[0].x, vertices[0].y, vertices[1].x, vertices[1].y)/2
    ...
    if (isEven) {
      ...
      */
      for (let i = 0; i < ((polygonPts+1)/2); i++){
        ...
        const conCirc1 = {} //{x,y}
        const conCirc1AngleOffset = angleInterval * ((polygonPts+1)/2)
        conCirc1.angle = refVertex.angle + conCirc1AngleOffset
        
        // Define the second of two connecting circles
        const conCirc2 = {} //{x,y}
        const conCirc2AngleOffset = -angleInterval * ((polygonPts+1)/2)
